...
#使用nginx申请证书
acme_nginx(){
  echo -e "${YELLOW}这种方法需要你安装有nginx$END"
...
- - - - - - - - - - - - - - - - - - - - - 
  6 -- 使用 nginx验证 申请域名证书
  7 -- 使用 apache验证 申请域名证书
  8 -- 使用 webroot 申请域名证书
- - - - - - - - - - - - - - - - - - - - - 
  9 -- 使用 Cloudflare API 申请域名证书
 10 -- 使用 手动验证dns记录 申请域名证书${END}
------------------------------------------
${GREEN}其他设置部分：
 11 -- 手动安装证书
 12 -- 设置 Acme 自动更新$END"
